...
router.get("/avatars", TokenGuard.verify, Validator.validate(avatarNameDto), UserController.getAccountAvatars);
router.patch("/avatar", TokenGuard.verify, UserController.patchAvatar);
